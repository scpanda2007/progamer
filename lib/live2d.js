(function () {
    ...
    function UtilDebug() {}
    UtilDebug._$Fm = 0;
    UtilDebug._$qf = new Object();
    UtilDebug.start = function (aD) {
        var aC = UtilDebug._$qf[aD];
        if (aC == null) {
            aC = new aa();
            aC._$d = aD;
            UtilDebug._$qf[aD] = aC;
        }
        aC._$2g = UtilSystem.getSystemTimeMSec();
    };
    UtilDebug.dump = function (aE) {
        var aC = UtilDebug._$qf[aE];
        if (aC != null) {
            var aD = UtilSystem.getSystemTimeMSec();
            var aF = aD - aC._$2g;
    ...
    UtilDebug._$bP = function (aD, aC) {
        console.log("_$bP : " + aD + "\n", aC);
    };
    UtilDebug._$GP = function (aD, aC) {
        console.log(aD, aC);
    };
    UtilDebug._$yT = function (aD, aC) {
        console.log(aD, aC);
        console.log("\n");
    };
    UtilDebug._$DT = function (aE, aD) {
    ...
    UtilDebug._$od = function (aG, aD, aF) {
        console.log("%s\n", aG);
        var aC = aD.length;
    ...
    W.prototype._$Cm = function () {
        UtilDebug._$bP("_$B2 _$Hf _$Cm()");
        return -1;
    };
    W.prototype._$wm = function (aC) {
        UtilDebug._$bP("_$B2 _$Hf _$gg#_$wm() \n");
    };
    ...
    function UtilSystem() {}
    UtilSystem._$lj = 0;
    UtilSystem._$xg = UtilSystem._$lj;
    UtilSystem._$8R = function () {
        return true;
    };
    UtilSystem._$rH = function (aD) {
        try {
            var aE = getTimeMSec();
    ...
    UtilSystem.getUserTimeMSec = function () {
        return (O._$xg == UtilSystem._$lj) ? UtilSystem.getSystemTimeMSec() : UtilSystem._$xg;
    };
    UtilSystem.setUserTimeMSec = function (aC) {
        UtilSystem._$xg = aC;
    };
    UtilSystem.updateUserTimeMSec = function () {
        return (O._$xg = UtilSystem.getSystemTimeMSec());
    };
    UtilSystem.getTimeMSec = function () {
        return new Date().getTime();
    };
    UtilSystem.getSystemTimeMSec = function () {
        return new Date().getTime();
    };
    UtilSystem._$6 = function (aC) {};
    UtilSystem._$Jf = function (aH, aE, aD, aG, aC) {
    ...
    S.prototype.startMotion = function (aE, aD) {
        ...
        for (var aF = 0; aF < aC; ++aF) {
            ...
            if (this._$uk) {
                UtilDebug._$GP("MotionQueueManager[size:%2d]->startMotion() / start _$D _$S (m%d)\n", aC, aG._$md);
            }
        }
        if (aE == null) {
            return -1;
        ...
        var aI = aG._$md;
        if (this._$uk) {
            UtilDebug._$GP("MotionQueueManager[size:%2d]->startMotion() / new _$L2 (m%d)\n", aC, aI);
        }
        return aI;
    };
    S.prototype.updateParam = function (aE) {
        try {
            ...
            for (var aF = 0; aF < this.motions.length; aF++) {
                ...
                if (aG.isFinished()) {
                    if (this._$uk) {
                        UtilDebug._$GP("MotionQueueManager[size:%2d]->updateParam() / _$f2 _$L2 (m%d)\n", this.motions.length - 1, aG._$md);
                    }
                    this.motions.splice(aF, 1);
                    aF--;
                } else {}
    ...
    L.prototype._$Mg = function (aE) {
        var aD = UtilSystem.getUserTimeMSec();
        var aC = aD + aE;
    ...
    u.prototype.setTexture = function (aD, aC) {
        if (this._$pR == null) {
            UtilDebug._$bP("_$9P for QT _$IP / _$rg() is _$B _$5P!!");
        }
    ...
    X.prototype._$jk = function (aH, aC) {
        ...
        if (!this._$Sj()) {
            ...
            if (aM._$Fd < 0) {
                if (P._$mR) {
                    UtilDebug._$bP("_$T _$2H _$X :: %s", aO);
                }
                aM._$vg(false);
            } else {
    ...
    ac.prototype.updateParam = function (aE, aI) {
        ...
        var aG = UtilSystem.getUserTimeMSec();
        if (aI._$pj < 0) {
            aI._$pj = aG;
            aI._$km = aG;
    ...
    q.setup = function () {
        ...
        function aD(aJ, aM) {
            ...
            for (var aH = 0; aH <= 2; aH++) {
                ...
                if (aK < 0 || aK > 999) {
                    UtilDebug._$bP("err : " + aK + " @UtHtml5.setup()");
                    aL = 0;
                    break;
                }
        ...
        if ((aG = aF.indexOf("iPhone OS ")) >= 0) {
            ...
            if ((aG = aF.indexOf("iPad")) >= 0) {
                ...
                if (aG < 0) {
                    UtilDebug._$bP(" err : " + aF + " @UtHtml5.setup()");
                    return;
                }
                aE.os = "iPad";
                aE._isIPad = true;
    ...
    w.prototype._$og = function (aC) {
        ...
        UtilSystem._$Jf(this._$mk, 0, aD, 0, this._$mk.length);
        this._$mk = aD;
        var aE = new Array();
        UtilSystem._$Jf(this._$1j, 0, aE, 0, this._$1j.length);
        this._$1j = aE;
    };
    ...
    am.prototype._$af = function (aD) {
        var aF = UtilSystem.getUserTimeMSec();
        var aC;
        var aE = 0;
        switch (this._$_T) {
        case STATE_CLOSING:
    ...
    aA.prototype.add = function (aD) {
        if (this._$H.length <= this.size) {
            ...
            UtilSystem._$Jf(this._$H, 0, aC, 0, this.size);
            this._$H = aC;
        }
    ...
    ao.clipWithTransform = function (aC, aD, aN, aI, aL, aF, aK, aE) {
        if (arguments.length < (1 + 3 * 2)) {
            UtilDebug._$bP("err : @LDGL.clip()");
            return;
        }
        if (!(arguments[1] instanceof ah)) {
            UtilDebug._$bP("err : a[0] is _$B LDTransform @LDGL.clip()");
            return;
        }
        var aH = ao._$c;
        var aJ = aD;
    ...
    ay.prototype.transform = function (aF, aD, aC) {
        ...
        case (ay.STATE_IDENTITY):
            if (aF != aD || aL != aI) {
                UtilSystem._$Jf(aF, aL, aD, aI, aC * 2);
            }
            return;
        }
    };
        ...
        try {
            ...
            if (!aG) {
                ...
                if (this._$Sj()) {
                    ...
                    if (aH._$Fd < 0) {
                        if (P._$mR) {
                            UtilDebug._$bP("_$T _$2H _$X :: %s", aC);
                        }
                    } else {
    ...
    x.prototype.draw = function (aH) {
        if (this._$lm == null) {
            UtilDebug._$bP("call _$CP.update() before _$CP.draw() ");
            return;
        }
    ...
    x.prototype._$1f = function (aE, aC) {
        var aD = new Float32Array(aC);
        UtilSystem._$Jf(aE, 0, aD, 0, aE.length);
        return aD;
    };
    x.prototype._$2j = function (aI, aH, aG, aC) {
        if (this._$MR >= this._$Wk.length) {
            ...
            UtilSystem._$Jf(this._$Wk, 0, aE, 0, aF);
            this._$Wk = aE;
            ...
            var aD = new Array();
            UtilSystem._$Jf(this._$Gm, 0, aD, 0, aF);
            this._$Gm = aD;
        }
    ...
    x.prototype.loadParam = function () {
        ...
        UtilSystem._$Jf(this._$qm, 0, this._$_j, 0, aC);
    };
    x.prototype.saveParam = function () {
        ...
        UtilSystem._$Jf(this._$_j, 0, this._$qm, 0, aC);
    };
    ...
    B.prototype.compileShader = function (aE, aI) {
        ...
        if (aF == null) {
            UtilDebug._$GP("_$T2 to create shader");
            return null;
        }
        ...
        if (!aC) {
            ...
            UtilDebug._$GP("_$T2 to compile shader : " + aD);
            aH.deleteShader(aF);
            return null;
        }
        return aF;
    ...
    B.prototype.loadShaders2 = function () {
        ...
        if (!aG) {
            UtilDebug._$GP("Vertex shader compile _$bP!");
            return false;
        }
        aC = this.compileShader(aI.FRAGMENT_SHADER, aH);
        if (!aC) {
            UtilDebug._$GP("Fragment shader compile _$bP!");
            return false;
        }
        ...
        if (!aD) {
            ...
            UtilDebug._$GP("_$T2 to link program: " + aE);
            if (aG) {
                aI.deleteShader(aG);
                aG = 0;
            }
    ...
    window.UtSystem = UtilSystem;
    window.UtDebug = UtilDebug;
